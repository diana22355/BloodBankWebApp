...
<div align="center">
<caption><h2><font color="#b30707">Existing Doctors' Requests</font></h2></caption>
...
while(rs.next())
	{
		...
		req_status = rs.getString("status_r");
		req_date = rs.getDate("date_request");
		req_liters = rs.getFloat("liters_r");
		blood_id = rs.getInt("blood_id");
		cert_id = rs.getString("certificate_id");
